  ...
  const projects: Project[] = [
    {
      ...
      detailedDescription: 'Built and maintain a personal home lab environment to experiment with modern infrastructure technologies, automation, and DevOps practices. This hands-on learning environment mirrors enterprise production setups and leverages GitOps principles for declarative infrastructure management with complete CI/CD capabilities.',
      features: [
        ...
        'Declarative configuration management with Git as single source of truth',
        'Monitoring and observability with Prometheus and Grafana',
        'Pi-hole for DNS-level ad blocking and network traffic analysis',
      ],
      tags: ['Kubernetes', 'FluxCD', 'GitOps', 'GitLab', 'CI/CD', 'Terraform'],
      gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
      githubUrl: '',
    },
    {
      title: 'Daily Stock Portfolio Tracker',
      description: 'Automated stock portfolio monitoring system that aggregates daily changes and sends email summaries.',
      detailedDescription: 'A full-stack application deployed on AWS that automatically tracks stock portfolio performance. The system runs daily after the Toronto Stock Exchange closes, aggregates changes using the Yahoo Finance API, and emails a comprehensive summary. Features a React TypeScript management interface for configuration and MongoDB for data persistence.',
      features: [
        ...
        'Automated daily execution using GitLab CI scheduled pipelines',
        'MongoDB database for storing configuration and historical data',
      ...
      tags: ['React', 'TypeScript', 'Python', 'MongoDB', 'AWS', 'GitLab CI'],
    ...
    },
    {
      ...
      features: [
        ...
        'Future enhancement: Full social media automation pending platform API access',
      ],
      tags: ['Python', 'GitLab CI', 'IFTTT', 'Google Forms', 'Automation'],
